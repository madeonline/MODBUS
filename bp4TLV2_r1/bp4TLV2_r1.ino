...
void control_system()                                           // УПРАВЛЕНИЕ
{
 ...
 {
     level2 =  counter1 * 20;                                            //Устанавливаем скважность ШИМ2 без регулировок
 }
  ...
  if (ceil(level2) != 255) analogWrite(pwm2, ceil(level2));               //подаем нужный сигнал на ШИМ2 выход (кроме 255, так как там какая-то лажа)
}                               // УПРАВЛЕНИЕ                            
